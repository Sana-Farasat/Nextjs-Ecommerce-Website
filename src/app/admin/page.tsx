...
// // app/admin/page.tsx
// // FIXED: "Unknown × 2" in items list
// // Problem: item.product is reference → need to fetch title from product doc
...
//   return (
//     <Suspense fallback={<div className="py-12 text-center">Loading admin...</div>}>
//       <AdminContent />
//     </Suspense>
//   );
// }
